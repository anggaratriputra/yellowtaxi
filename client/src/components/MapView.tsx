...
const MapView: React.FC<MapViewProps> = ({ trips, selectedTripId, onTripClick }) => {
  ...
  return (
    <div className="flex justify-center">
      <MapContainer center={[40.758896, -73.98513]} zoom={12} style={{ height: "750px", width: "100%", borderRadius: "20px" }}>
          ...
          return (
            <React.Fragment key={trip.id}>
              ...
              {isSelected && (
                <Marker
                  key={`${trip.id}-dropoff`}
                  position={[trip.route[1].lat, trip.route[1].lng]}
                  icon={dropoffIcon}
                >
                  <Popup>
                    Dropoff Location
